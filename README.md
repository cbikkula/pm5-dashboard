...
**Current release: `v1.15.1`** ([changelog](CHANGELOG.md)) · single 596 KB `index.html`, no framework, no build step.
...
| Released versions                | **23** (v1.0.0 → v1.15.1; [changelog](CHANGELOG.md)) · 7 git tags |
