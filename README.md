...
| **Per-stroke Force Curve storage + true stroke replay** *(v1.21)* | ✅ versioned codec, 512 KiB/session budget, coverage disclosed |
...
| Per-stroke curves stored (v1.21) | every stroke, ≤ **512 KiB/session**, ~76 B/stroke |
