...
**Current release: `v1.16.0`** ([changelog](CHANGELOG.md)) · single 597 KB `index.html`, no framework, no build step.
...
| Released versions                | **24** (v1.0.0 → v1.16.0; [changelog](CHANGELOG.md)) · 7 git tags |
